...
per entry, which for `mutations.py` alone outgrew one 600-second call. This
command answers the anchoring question ALONE: it reads the entries, counts
substrings, spawns no suite and copies nothing, and finishes in about a second. So a reflow of a
