...
`blocked` · `discarded`. The gate refuses anything else, because the CSS that colours a card
knows only these — a card carrying an eighth word renders grey and reads as unremarkable. Grouping headings
