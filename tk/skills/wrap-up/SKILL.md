...
MEASURES rather than recalls, and the degraded form a PR with no trail gets are in
`../../reference/dossier.md`. A PR the verdicts hold back gets one too: the user's decision
