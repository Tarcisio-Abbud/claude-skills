...
PRs — and print the inventory. The fetch comes first: a sibling session in another clone
is a fact to know now, not a rejected push at the end of the gate. Add the
...
closes it whole, and a finding whose answer turns into work goes to step 2's survival
gates.
