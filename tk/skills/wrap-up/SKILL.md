...
fetch comes first: a sibling session in another clone is a fact to know now, not a
rejected push at the end of the gate. Add the **facts/decisions/learnings** from the
